 ...
 */
package io.reactivesocket.netty.udt;
...
import io.reactivesocket.netty.udt.client.ClientUdtDuplexConnection;
import io.reactivesocket.netty.udt.server.ReactiveSocketServerHandler;
...
public class ClientServerTest {
    ...
    static ThreadFactory acceptFactory = new DefaultThreadFactory("accept");
    static ThreadFactory connectFactory = new DefaultThreadFactory("connect");
    static NioEventLoopGroup acceptGroup =
            new NioEventLoopGroup(1, acceptFactory, NioUdtProvider.MESSAGE_PROVIDER);
    static NioEventLoopGroup connectGroup =
    ...
    public static void setup() throws Exception {
        ...
        ClientUdtDuplexConnection duplexConnection = RxReactiveStreams.toObservable(
            ClientUdtDuplexConnection.create(InetSocketAddress.createUnresolved("localhost", 7878))
        ).toBlocking().single();
