...
public class Ping {
    public static void main(String... args) throws Exception {
        Publisher<ClientUdtDuplexConnection> publisher = ClientUdtDuplexConnection
            .create(InetSocketAddress.createUnresolved("localhost", 7878));

        ClientUdtDuplexConnection duplexConnection = RxReactiveStreams.toObservable(publisher).toBlocking().last();
